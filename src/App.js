...
export default function App() {
  ...
  function categoryScore(catKey) {
    ...
    const value = qs.reduce(
      (sum, _, i) => sum + (ANSWER_SCORE[a[i]] ?? 0),
      0
    );
      ...
      <div className="screen">
        ...
        <div className="progressWrap">
          <div className="progressText">
            Frage {answeredCount + 1} von {totalQuestions}
          </div>
  ...
  return (
    <div className="screen">
          ...
          <div key={c.key} className="categoryItem">
            ...
            {s < 70 && (
              <div className="recommendation">
                Empfehlung: Handlungsbedarf in {c.label}
              </div>
            )}
          </div>
        );
      ...
      <button
        ...
        onClick={() =>
          alert(
            "DIN-Protokoll / PDF-Export\n(technisch vorbereitet – Backend folgt)"
          )
        }
      >
